...
abstract class Usuarios implements ActiveRecordInterface
{
    ...
    public function setLogin($v)
    {
        ...
        if ($this->login !== $v) {
            $this->login = $v;
            $this->modifiedColumns[UsuariosTableMap::COL_LOGIN] = true;
        }
    ...
    public function setPassword($v)
    {
        ...
        if ($this->password !== $v) {
            $this->password = $v;
            $this->modifiedColumns[UsuariosTableMap::COL_PASSWORD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsuariosTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nome = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UsuariosTableMap::translateFieldName('Login', TableMap::TYPE_PHPNAME, $indexType)];
            $this->login = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsuariosTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = UsuariosTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_LOGIN)) {
            $modifiedColumns[':p' . $index++]  = 'login';
        }
        if ($this->isColumnModified(UsuariosTableMap::COL_PASSWORD)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_LOGIN)) {
            $criteria->add(UsuariosTableMap::COL_LOGIN, $this->login);
        }
        if ($this->isColumnModified(UsuariosTableMap::COL_PASSWORD)) {
            $criteria->add(UsuariosTableMap::COL_PASSWORD, $this->password);
        }
