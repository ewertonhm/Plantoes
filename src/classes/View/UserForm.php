                    ...
                    <div class="mdl-cell ">
                        <form method="post" action="" autocomplete="off">
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" id="nome"  pattern="[A-Z,a-z, ]*">
                                <label class="mdl-textfield__label" for="nome">Nome</label>     
                                <span class="mdl-textfield__error">Apenas letras e espaços</span>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" id="login"  pattern="[A-Z,a-z,0-9]*">
                            ...
                            <div>
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" type="submit" id="btn-cadastrar" nome="btn-cadastrar">
                                  Salvar
                                </button>  
                            </div>
                        </form>                    
