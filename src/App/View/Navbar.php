        ...
        <div class="container-fluid"><a class="navbar-brand" href="index.php">Agenda</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item dropdown" id="1-columna"><a class="dropdown-toggle nav-link disabled" data-toggle="dropdown" aria-expanded="false" href="#">Plantões&nbsp;</a>
                    ...
                    <li class="nav-item dropdown" id="2-columnas"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Juízes&nbsp;</a>
			            ...
			            <div class="col-sm-6">
				            <ul class="multi-column-dropdown">
					            <li><a class="dropdown-item" href="cadastrar-juiz.php">Cadastrar</a></li>
                    ...
                    <li class="nav-item dropdown" id="1-columna"><a class="dropdown-toggle nav-link disabled" data-toggle="dropdown" aria-expanded="false" href="#">Cidades&nbsp;</a>
                    ...
                    <li class="nav-item dropdown" id="1-columna"><a class="dropdown-toggle nav-link disabled" data-toggle="dropdown" aria-expanded="false" href="#">Feriados&nbsp;</a>
                        <div class="dropdown-menu" role="menu" style="background-color: rgb(255,255,255);"><a class="dropdown-item" role="presentation" href="#">Cadastrar</a><a class="dropdown-item" role="presentation" href="#">Listar</a><a class="dropdown-item" role="presentation" href="#">Deletar</a></div>
                    </li>
                    ...
                    <li class="nav-item dropdown " id="1-columna"><a class="dropdown-toggle nav-link disabled" data-toggle="dropdown" aria-expanded="false" href="#">Usuários&nbsp;</a>
                        <div class="dropdown-menu" role="menu" style="background-color: rgb(255,255,255);"><a class="dropdown-item" role="presentation" href="#">Cadastrar</a><a class="dropdown-item" role="presentation" href="#">Listar</a><a class="dropdown-item" role="presentation" href="#">Deletar</a></div>
                    </li>
